...
import entity.MenuDetailExample.Criteria;
import entity.MenuDetailExample.Criterion;
import entity.MenuDetailExample;
...
public class MenuDetailSqlProvider {
     ...
     */
    public String countByExample(MenuDetailExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("MENU_DETAIL");
     ...
     * @mbg.generated generated automatically, do not modify!
     */
    public String deleteByExample(MenuDetailExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("MENU_DETAIL");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated generated automatically, do not modify!
     */
    public String insertSelective(MenuDetail row) {
        SQL sql = new SQL();
        sql.INSERT_INTO("MENU_DETAIL");
     ...
     * @mbg.generated generated automatically, do not modify!
     */
    public String selectByExample(MenuDetailExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        MenuDetail row = (MenuDetail) parameter.get("row");
        MenuDetailExample example = (MenuDetailExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("MENU_DETAIL");
     ...
     * @mbg.generated generated automatically, do not modify!
     */
    public String updateByPrimaryKeySelective(MenuDetail row) {
        SQL sql = new SQL();
        sql.UPDATE("MENU_DETAIL");
     ...
     * @mbg.generated generated automatically, do not modify!
     */
    protected void applyWhere(SQL sql, MenuDetailExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
