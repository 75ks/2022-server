...
public class ReserveRegisterController {
     ...
     */
    @GetMapping("/")
    public ResponseEntity<Integer> getRankId(@RequestHeader("CustomerAuthorization") String jwt, RegisterReserveRankIdReq reqForm) throws AuthenticationException {
        Integer rankId = reserveRegisterServiceImpl.getRankId(reqForm);
