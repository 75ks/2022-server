...
public class StuffCreateController {
     ...
     */
    @PostMapping("")
    public ResponseEntity<StuffCreateRes> register(@RequestHeader("Authorization") String jwt, @RequestBody @Valid StuffCreateReq reqForm) throws AuthenticationException {
        // JWTから店舗IDを取得する
