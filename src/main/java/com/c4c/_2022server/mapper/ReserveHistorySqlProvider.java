...
public class ReserveHistorySqlProvider {
    ...
    public String select0001(ReserveHistoryReq reqForm) {
        ...
        sql.INNER_JOIN(
                ...
                , "MENU_HEADER ON MENU_HEADER.STORE_ID = RESERVE_HISTORY.STORE_ID AND MENU_HEADER.MENU = RESERVE_HISTORY.MENU"
        );
        sql.LEFT_OUTER_JOIN(
                "SALES_HISTORY ON SALES_HISTORY.RESERVE_HISTORY_ID = RESERVE_HISTORY.RESERVE_HISTORY_ID"
        );
